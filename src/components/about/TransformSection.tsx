  ...
  return (
    <div className="w-full bg-white dark:bg-slate-800">
      <div className="max-w-7xl mx-auto py-10 px-4 ">
        <div
          style={{ color: "#002770" }}
          className="relative isolate overflow-hidden dark:bg-[#002770] px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16"
        >
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <button
              ...
              className="BTN-PRIMARY flex items-center justify-center text-white bg-[#007BFF] font-medium border-0 py-2 xl:py-3 px-6 focus:outline-none hover:bg-sky-400 rounded-lg text-sm sm:text-base 2xl:text-lg transition-colors duration-500"
            >
              Get Started
            </button>
