          ...
          <ul className="w-full flex items-center justify-center gap-8">
            <li>
              <button className="text-link">
                <div
                  ...
                  data-link="link=about-us&amp;target=_blank&amp;text=About%20Us"
                >
            ...
            <li>
              <button className="text-link">
                <div
                  className="_editable_jwu41_1 undefined"
                  data-link="link=services&amp;target=_blank&amp;text=Our%20Services"
                >
            ...
            <li>
              <button className="text-link">
                <div
                  ...
                  data-link="link=home&amp;target=_blank&amp;text=Home"
                >
                  <Link to="/crm" className="hover:text-blue-500">
                    CRM
                  </Link>
                </div>
              </button>
          ...
          <div className="flex flex-col items-center gap-8 md:justify-between md:flex-row">
              ...
              <ul className="flex items-center gap-8">
                <li>
                  <a href="https://twitter.com/Versabit">
                    <button className="text-link">
                      <div
                        className="_icon-wrapper_1a3wa_1 text-lg"
                        data-library="FontAwesome"
                        data-link="link=&amp;target=_blank"
                      >
                        <svg
            ...
            >
              <div className="_editable_kt7nh_1 undefined">
                <span>
                  © Versabit {new Date().getFullYear()}. All rights reserved.
                </span>
              </div>
            </div>
          </div>
