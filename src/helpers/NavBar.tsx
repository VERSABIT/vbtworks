...
const Header: React.FC = () => {
  ...
  return (
    <header
      className="flex justify-between items-center top-0 w-full h-16 bg-white/80  sm:pr-10 sm:pl-10 md:px-36 "
    ...
    >
      ...
      <button
        className="md:hidden text-4xl text-white-700"
        onClick={toggleMenu}
      >
        {isOpen ? <FaTimes /> : <FaBars />}
      </button>
      {isOpen && (
        <div className="md:hidden fixed top-16 right-0 w-full h-1/4 bg-white shadow-lg rounded-l-lg p-12 z-50">
